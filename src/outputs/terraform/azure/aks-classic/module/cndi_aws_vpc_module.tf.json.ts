...
import {
  ...
  parseNetworkConfig,
} from "src/outputs/terraform/shared/network-utils.ts";

import { ccolors } from "deps";

const MODULE_SOURCE =
  "git::https://github.com/terraform-azure-modules/terraform-azure-vpc.git?ref=573f574c922782bc658f05523d0c902a4792b0a8";
...
export default function (cndi_config: CNDIConfig): string | null {
  ...
  return getPrettyJSONString({
    module: {
      cndi_azure_vpc_module: {
        azs: "${data.azure_availability_zones.available-zones.names}",
        cidr: "10.0.0.0/16",
        create_vpc: true,
