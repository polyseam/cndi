...
# Kubeseal Keypair
SEALED_SECRETS_PRIVATE_KEY_MATERIAL="${SEALED_SECRETS_PRIVATE_KEY_MATERIAL.replaceAll('\n','_')}"
SEALED_SECRETS_PUBLIC_KEY_MATERIAL="${SEALED_SECRETS_PUBLIC_KEY_MATERIAL.replaceAll('\n','_')}"
