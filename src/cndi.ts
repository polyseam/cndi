...
import { checkInstalled, getFileSuffixForPlatform, getPathToOpenSSLForPlatform } from "./utils.ts";
...
export default async function main(args: string[]) {
  ...
  const pathToKubeseal = path.join(CNDI_HOME, `kubeseal-${fileSuffixForPlatform}`);
