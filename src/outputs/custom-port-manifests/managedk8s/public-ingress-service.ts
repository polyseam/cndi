...
const ingressTcpServicesConfigMapManifestLabel = ccolors.faded(
  "\nsrc/outputs/custom-port-manifests/managedk8s/public-ingress-service.ts:",
);
...
const getPublicIngressServiceManifest = (
...
export default getPublicIngressServiceManifest;
