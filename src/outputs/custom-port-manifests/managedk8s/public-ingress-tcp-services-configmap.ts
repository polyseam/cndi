...
const ingressTcpServicesConfigMapManifestLabel = ccolors.faded(
  "\nsrc/outputs/custom-port-manifests/managedk8s/public-ingress-tcp-services-configmap.ts:",
);
...
const getPublicIngressTcpServicesConfigMapManifest = (
...
export default getPublicIngressTcpServicesConfigMapManifest;
