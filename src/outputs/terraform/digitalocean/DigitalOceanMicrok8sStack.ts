...
// import AzureCoreTerraformStack from "./DigitalOceanCoreStack.ts";
...
//         {
//           name: `cndi-digitalocean-lb-frontend-ip-configuration`,
...
//       skuTier: "Regional",
//       location: this.rg.location!,
//       name: `cndi-digitalocean-load-balancer`,
//       resourceGroupName: this.rg.name,
//       tags,
//     });
...
//         name: `cndi-digitalocean-lb-backend-addres-pool`,
//       },
//     );
...
//         {
//           loadbalancerId: lb.id,
//           name: `cndi-digitalocean-lb-probe_${port.number}`,
//           port: port.number,
//         },
//       );
...
//         DEFAULT_INSTANCE_TYPES.digitalocean;
//       // digitalocean uses 'size' to describe the machine type, oof
//       if (
//         nodeSpec?.size &&
...
//               {
//                 name:
//                   `cndi-digitalocean-network-interface-ip-configuration_${nodeName}`,
//                 subnetId: subnet.id,
...
//             location: this.rg.location,
//             resourceGroupName: this.rg.name,
//             name: `cndi-digitalocean-network-interface_${nodeName}`,
//             tags,
//           },
//         );
