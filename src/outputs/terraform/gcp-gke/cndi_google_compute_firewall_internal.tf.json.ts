  ...
  const resource = getTFResource(
    "google_compute_firewall",
    {
      ...
      source_ranges: [
        ...
        "${google_compute_subnetwork.cndi_google_compute_subnetwork.secondary_ip_range[0].ip_cidr_range}",
        "${google_compute_subnetwork.cndi_google_compute_subnetwork.secondary_ip_range[1].ip_cidr_range}",
      ],
    },
